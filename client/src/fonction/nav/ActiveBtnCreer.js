export default function activeBtnCreer(errTypeSignUp,errNbSignUp,btnref){
    if(errTypeSignUp.mdp!=="Sécurité faible" && !errTypeSignUp.nom && !errNbSignUp.nom && !errTypeSignUp.prenom && !errNbSignUp.prenom && !errNbSignUp.pseudo && !errTypeSignUp.mail && !errNbSignUp.mail && !errNbSignUp.mdp && !errTypeSignUp.confirmMdp){

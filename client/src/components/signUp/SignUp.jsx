  ...
  return (
    <form onSubmit={(e)=>e.preventDefault()} ref={formSignUp} className="sup377:w-[350px] sup480:h-[570] sup480:w-[400px] sup768:w-[470px] sup768:h-[620px]  sup1024:w-[530px] sup1024:h-[680px] sup1600:h-[720px] sup1600:w-[550px] fixed top-2/4 left-2/4 w-full h-[550px]  bg-gradient-to-r from-vertFoncer from-0%  to-vertClair to-100% z-50 -translate-x-2/4 -translate-y-2/4 rounded-3xl py-[39px] px-[12px] hidden flex-col items-center justify-between ">
      <div className="flex items-center justify-center w-full relative text-blanc">
        ...
        <button onClick={()=>setSignUpProps(!setSignUpProps)} className="sup480:top-[-1px] sup768:top-[2px] sup1024:top-[6px] size-7 absolute right-0  rounded-full border-none bg-noir  transition-all hover:scale-[1.2] hover:cursor-pointer ">
      ...
      <DivInputSignUp nbUn={0} nbDeux={1} seterrorMsg={seterrorMsg} setnom={setnom} setprenom={setprenom}/>
      <DivLabelSignUp nbUn={2} nbDeux={3}/>
      <DivInputSignUp nbUn={2} nbDeux={3} labelUn="Pseudonyme" LabelDeux="Mail"  seterrorMsg={seterrorMsg} setnom={setpseudonyme} setprenom={setemail}/>
      <DivLabelSignUp nbUn={4} nbDeux={5}/>
      <DivInputSignUp nbUn={4} nbDeux={5}  seterrorMsg={seterrorMsg} setnom={setpassword} setprenom={setconfirmMdp} />

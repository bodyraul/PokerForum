...
export default function AfficherAllPost() {
  ...
  return (
    <div className=" sup480:w-[450px] sup480:h-[730px] sup768:w-[700px] sup768:h-[870px] sup1024:w-[850px] sup1024:h-[1020px] sup1600:w-[1000px] sup1600:h-[1170px] w-full mt-0  mx-auto max-w-[1800px] h-[625px] ">

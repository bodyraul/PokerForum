...
export default function RechercheParCategorie({categories}) {
  return (
    <div className=" sup1024:w-[95%]   sup1024:h-auto sup1024:flex sup1024:flex-row sup1024:items-center sup1024:justify-between  py-2.5 px-0 h-80 mx-auto my-0 mt-24 flex flex-col-reverse items-center justify-evenly border-solid border border-gris w-full max-w-[1800px]">

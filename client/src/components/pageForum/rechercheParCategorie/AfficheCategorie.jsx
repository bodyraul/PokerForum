...
export default function AfficheCategorie({boolCategorieSearch,choiseCategoriesSearch}) {
    ...
    if(boolCategorieSearch){
        return(
            <div className="sup480:bottom-[-131px] sup480:w-[100px] sup768:bottom-[-166px] sup768:w-[100px] sup1024:bottom-[-191px] sup1024:w-[110px] sup1600:bottom-[-202px] sup1600:w-[150px] absolute bg-blanc w-[90px] left-[-1px]  bottom-[-112px]  z-10 p-0 border-solid border border-vertFoncer border-b-0 flex-col items-center justify-center">

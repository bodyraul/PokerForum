...
export default function NavUserDeconnecter() {
  ...
  return (
     <div className="sup480:h-[70px]  sup768:h-[80px] sup1024:h-[95px] sup1600:h-[105px] h-[50px] fixed top-0 z-50 w-screen  flex items-center justify-center  ">
        <nav className=" sup480:h-[55px] sup768:h-[65px] sup1024:h-[75px] sup1600:h-[85px] h-[40px]  w-[85%] bg-vertFoncer  flex items-center justify-evenly rounded-bl-3xl rounded-tr-3xl max-w-[1800px]">

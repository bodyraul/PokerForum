...
export default function RecherchePostMsg({texte}) {
  ...
  return (
    <div className="sup1600:w-2/5 sup1600:px-[24px] sup1600:py-[0px] py-7 px-0 w-full flex-col items-center ">
        <div className=" sup1600:w-400 sup1600:ml-0 border-solid border-2 border-gris w-4/5 h-24 ml-8"></div>
